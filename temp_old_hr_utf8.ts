...
@Component({
  ...
  template: `
    ...
    >
      <!-- Header Compacto con B├║squeda Global -->
      <div
      ...
      >
        <div class="px-4 py-2">
          <div class="flex items-center justify-between mb-2 gap-4">
            <div class="flex-1 min-w-0">
              ...
              >
                ...
                <span class="truncate"
                  >Gesti├│n integral de solicitudes y tiempo compensatorio</span
                >
              </p>
            </div>
            <div class="flex items-center gap-2 flex-shrink-0">
              <p-button
                ...
                pTooltip="Ver historial de auditor├¡a completo"
          ...
          <!-- B├║squeda Global Compacta -->
          <div class="relative">
            <input
              type="text"
              pInputText
              placeholder="­ƒöì B├║squeda r├ípida: empleado, email, descripci├│n, motivo..."
      ...
      <div class="px-4 py-2 space-y-2 flex-1 overflow-y-auto">
        ...
        <!-- Dashboard de Gesti├│n de Solicitudes -->
        <div class="space-y-3">
              ...
              <div class="grid grid-cols-1 md:grid-cols-3 gap-2">
                <div class="md:col-span-2">
                  ...
                  <input
                    type="text"
                    pInputText
                    placeholder="Empleado, email, descripci├│n..."
                    [(ngModel)]="searchText"
          ...
          >
            ...
            >
              ...
              <p class="text-gray-500 text-xs mb-2">
                Intenta ajustar los filtros para ver m├ís resultados
              </p>
              <p-button
                  ...
                  <tr>
                    ...
                    <th style="padding: 0.5rem; text-align: center;">
                      <div class="flex items-center justify-center gap-1">
                        ...
                        <span class="text-xs">Descripci├│n</span>
                      </div>
                    </th>
                    <th
                      style="width: 100px; padding: 0.5rem; text-align: center;"
        ...
        <div class="space-y-3">
          <!-- Estad├¡sticas Compactas de Tiempo Compensatorio -->
          <div class="grid grid-cols-4 gap-2">
            <!-- Total -->
            <div
              class="group relative bg-gradient-to-br from-neutral-800 to-neutral-800/80 rounded-lg p-3 border border-neutral-700/50 hover:border-cyan-400/50 transition-all duration-200 hover:shadow-lg hover:shadow-cyan-500/10 cursor-pointer"
                  ...
                  >
                    ...
                    <td style="padding: 0.4rem; text-align: center;">
                      ...
                      <span class="text-xs font-medium text-white">
                        @if (compensatoryType === 'days') { D├¡as } @else if
                    ...
                    <td style="padding: 0.4rem; text-align: center;">
                      ...
                      <span class="text-xs font-medium text-white">
                        ...
                        (type === 'days') { d├¡a(s) } @else { hora(s) } } @else
                        if (quantity && quantity.value > 0) { @if
                        (quantity.isDays) {
                        {{ quantity.value }} d├¡a(s) } @else {
    ...
    >
      ...
      <div class="space-y-4 pt-4">
        <!-- Informaci├│n del Empleado y Resumen de Incapacidad (lado a lado) -->
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            ...
            <div class="flex items-center justify-between mb-3">
              <div>
                <p class="text-sm text-gray-400 mb-1">Duraci├│n total</p>
    ...
    >
      ...
      <div class="space-y-4 pt-4">
        <!-- Informaci├│n del Empleado y Horas Extras Disponibles (lado a lado) -->
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <!-- Informaci├│n del Empleado -->
          <div class="p-4 bg-neutral-800 rounded-lg border border-neutral-700">
            <h3
          ...
          <!-- Horas Extra Pendientes (hist├│rico) -->
          <div
          ...
          >
            ...
            <!-- Mostrar d├¡as con horas extras -->
            <div class="mt-3">
              <p class="text-xs font-medium text-gray-300 mb-2">
                D├¡as con saldo pendiente (mostrando ├║ltimos
              ...
              <div class="mt-3 flex items-center justify-between gap-2">
                <p class="text-[11px] text-gray-400 m-0">
                  Cargando hist├│rico: ├║ltimos
                  {{ overtimeHistoryWindowDays() }} d├¡as
                </p>
                <p-button
                  label="Cargar m├ís"
                  icon="pi pi-plus"
            ...
            <p class="text-xs text-gray-400 mt-3">
              No hay d├¡as con horas extra pendientes dentro del rango cargado.
            </p>
            } }
          </div>
        </div>
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p class="text-white">
                ...
                {{ quantity.value }} d├¡a(s) ({{ quantity.value * 8 }} horas) }
                @else {
                {{ formatHoursMinutes(quantity.value) }}
                } } @else {
            ...
            <div>
              <label class="block text-sm font-medium text-gray-400 mb-1"
                >Per├¡odo Registrado</label
              >
              <p class="text-white">{{ dateFrom }} ÔåÆ {{ dateTo }}</p>
            </div>
            } } @let timeInfo =
            ...
            <div class="col-span-2">
              <label class="block text-sm font-medium text-gray-400 mb-2"
                >D├¡as donde trabaj├│ horas extra (reportados por el
                empleado)</label
              >
              ...
              <p class="text-xs text-gray-400 mt-2">
                Total de d├¡as reportados: {{ overtimeDates.length }}
              </p>
            </div>
            }
          </div>
        ...
        <!-- Fechas donde trabaj├│ horas extra -->
            ...
            <div class="space-y-3">
              ...
              >
                ...
                <div class="p-4 space-y-3">
                  ...
                  <!-- Contenido expandible con m├ís detalles -->
                  @if (isExpanded) {
                  <div
    ...
    <!-- Dialog de Historial de Auditor├¡a Completo -->
    <p-dialog
      [(visible)]="showAuditHistoryDialog"
      [modal]="true"
      [style]="{ width: '90vw', maxWidth: '1000px' }"
      [header]="'Historial de Auditor├¡a - Tiempo Compensatorio'"
      [draggable]="false"
      [resizable]="false"
      [dismissableMask]="true"
    >
      <div class="space-y-4 pt-4">
        ...
        <div class="flex items-center justify-center gap-2 text-gray-400 py-8">
          <i class="pi pi-spin pi-spinner"></i>
          <span>Cargando historial de auditor├¡a...</span>
        </div>
  ...
  styles: `
    ...
    /* Estilos espec├¡ficos para la tabla de horas extra */
...
export class HRDisabilitiesComponent {
  ...
  // M├®todo para navegar a diferentes pesta├▒as
  public navigateToTab(
    ...
    if (tab === 'documents') {
      ...
      // Cambiar a la pesta├▒a de vacaciones
      this.activeTab.set('vacations');
      // TODO: Implementar vista de vacaciones
    } else if (tab === 'suggestions') {
      // Navegar al buz├│n de sugerencias
      this.router.navigate(['admin', 'suggestions-inbox']);
    } else {
      // Para disabilities y compensatory, solo cambiar la pesta├▒a activa
      this.activeTab.set(tab);
    }
  }

  // API para obtener incapacidades con informaci├│n del empleado
  public disabilitiesApi = httpResource<Disability[]>(() => {
    ...
    const params: any = {
      // Ahora podemos filtrar directamente por company_id ya que se agreg├│ el campo a la tabla
  ...
  // Nuevas se├▒ales para el dashboard mejorado
  ...
  // Historial: por defecto cargamos 1 a├▒o hacia atr├ís y permitimos ampliar
  ...
  // Se├▒ales para edici├│n de comentarios
  ...
  public calculateHoursFromDates(
    ...
    // Validar que las fechas sean v├ílidas
  ...
  public getCompensatoryQuantity(data: CompensatoryRequest): {
    ...
    // Primero intentar determinar si es d├¡as u horas desde las notas o el campo compensatory_type
    let isDays = false;
    ...
    // 2. Intentar desde las notas
      ...
      // 3. Si no hay nota de tipo, determinar por el formato de las fechas y la diferencia
        ...
        if (hasTimeInFrom && hasTimeInTo) {
          ...
          const days = hours / 24;
          // Si la diferencia es un n├║mero entero de d├¡as (tolerancia peque├▒a)
    ...
    if (isDays === true) {
      // Calcular d├¡as desde fechas o usar compensatory_amount
      let days = 0;
      ...
      if (data.compensatory_amount) {
        ...
        // Si el resultado es muy grande (m├ís de 24 horas), probablemente es un error
        // y deber├¡a ser d├¡as en lugar de horas
        if (hours >= 24 && hours % 24 < 0.1) {
          // Es un n├║mero entero de d├¡as, convertir a d├¡as
    ...
    if (amount > 0) {
      // Si hay amount pero no type, asumir horas (m├ís com├║n)
  ...
  public getCompensatoryReasonFromNotes(
    ...
    // Intentar desde las notas - la primera nota que no est├® vac├¡a y no sea t├®cnica
    if (data.notes) {
      const notesArray = Array.isArray(data.notes)
        ? data.notes
        : typeof data.notes === 'string'
      ...
      // Buscar la primera nota que no sea informaci├│n t├®cnica (Tipo, Cantidad, etc.)
  ...
  // Nuevas funciones para obtener informaci├│n adicional de compensatory
  ...
  public onFilterChange(): void {
    // Los filtros se aplican autom├íticamente mediante computed
  }
  ...
  // M├®todos helper para el dashboard mejorado
  ...
  public onGlobalSearch(): void {
    // La b├║squeda global se aplica autom├íticamente mediante computed
  ...
  public bulkApprove(): void {
    ...
    this.confirmationService.confirm({
      message: `┬┐Est├ís seguro de aprobar ${selected.length} incapacidad(es) seleccionada(s)?`,
      header: 'Confirmar Aprobaci├│n Masiva',
  ...
  public bulkReject(): void {
    ...
    this.confirmationService.confirm({
      message: `┬┐Est├ís seguro de rechazar ${selected.length} incapacidad(es) seleccionada(s)?`,
  ...
  public async exportData(): Promise<void> {
    try {
      ...
      const data = await Promise.all(
        requests.map(async (req) => {
          ...
          return {
            ...
            Email: employeeEmail,
            Posici├│n: req.employee?.position?.name || 'N/A',
            ...
            'Fecha Hasta': req.date_to
              ...
              : '',
            Tipo: req.compensatory_type === 'hours' ? 'Horas' : 'D├¡as',
            ...
            'Fecha Revisi├│n': req.reviewed_at
      ...
      const summaryData = [
        ...
        ['Fecha Exportaci├│n', format(new Date(), 'dd/MM/yyyy HH:mm:ss')],
        ...
        [''],
        ['Filtros Aplicados'],
        ['B├║squeda', this.compensatorySearchText() || 'Ninguna'],
        [
          'Estado',
  ...
  // Estad├¡sticas de tiempo compensatorio
  ...
  // Helper methods para obtener informaci├│n del empleado
    ...
    this.http
      ...
      .subscribe({
        next: (timeoffs) => {
          ...
          // Obtener todo el historial de auditor├¡a para estos timeoffs
          this.http
            .get<TimeoffAuditLog[]>(
  ...
  public getActionLabel(action: string): string {
    const labels: Record<string, string> = {
      created: 'cre├│ la solicitud',
      status_changed: 'cambi├│ el estado',
      approved: 'aprob├│ la solicitud',
      rejected: 'rechaz├│ la solicitud',
      registered: 'registr├│ la solicitud',
      updated: 'actualiz├│ la solicitud',
    };
  ...
  // M├®todo helper para parsear las notas y extraer informaci├│n de fechas de horas extra
  public getOvertimeDaysFromNotes(request: CompensatoryRequest): Array<{
    ...
    // Buscar la secci├│n "--- Fechas donde trabaj├│ horas extra ---"
    const startIndex = notesArray.findIndex(
      (note) =>
        typeof note === 'string' &&
        note.includes('--- Fechas donde trabaj├│ horas extra ---')
    );

    if (startIndex === -1) return null;

    // Extraer las l├¡neas de detalle por fecha (despu├®s de "Detalle por fecha:")
    ...
    // Parsear cada l├¡nea de detalle
    for (let i = detailStartIndex + 1; i < notesArray.length; i++) {
      const note = notesArray[i];
      if (typeof note !== 'string') continue;

      // Formato nuevo con delay: "dd/MM/yyyy: Entrada HH:mm - Salida HH:mm | Total: X.XXh (despu├®s de restar almuerzo y retraso) | Almuerzo: X.XXh | Retraso: X.XXh | Extra: X.XXh"
  ...
  // Funci├│n para extraer rango de horas desde notes o date_from/date_to
  public getCompensatoryTimeRange(request: CompensatoryRequest): {
    ...
    // Si no est├í en notes, intentar extraer desde date_from y date_to (si son datetime)
  ...
  // Funci├│n para extraer las fechas manuales desde notes
  public getManualOvertimeDates(request: CompensatoryRequest): string[] {
    ...
    if (Array.isArray(request.notes)) {
      ...
      try {
        ...
        // No es JSON v├ílido, tratarlo como string simple
        notesArray = [request.notes];
        console.log(
          '[DEBUG HR] Notes no es JSON v├ílido, tratado como string simple:',
          notesArray
        );
      }
    } else {
    ...
    const startIndex = notesArray.findIndex(
      (note) =>
        typeof note === 'string' &&
        note.includes(
          '--- Fechas donde trabaj├│ horas extra (ingresadas manualmente) ---'
        )
    );

    console.log('[DEBUG HR] ├ìndice de inicio encontrado:', startIndex);

    if (startIndex === -1) {
      console.log('[DEBUG HR] No se encontr├│ el patr├│n de fechas manuales');
      return [];
    }
    ...
    for (let i = startIndex + 1; i < notesArray.length; i++) {
      ...
      if (typeof note === 'string') {
        ...
        } else if (note.includes('RRHH revisar├í')) {
          // Si encontramos el texto final, parar
          console.log('[DEBUG HR] Fin de fechas encontrado en ├¡ndice:', i);
          break;
        }
        // Si es l├¡nea vac├¡a, continuar sin hacer nada (no romper el loop)
      }
    }

    console.log('[DEBUG HR] Fechas manuales extra├¡das:', dates);
    console.log('[DEBUG HR] Longitud del array de fechas:', dates.length);
    console.log('[DEBUG HR] ┬┐Array vac├¡o?:', dates.length === 0);
  ...
  // M├®todo helper para calcular horas extras de un empleado espec├¡fico
  private async loadEmployeeOvertimeHours(employeeId: string): Promise<void> {
    ...
    try {
      ...
      // Traer marcaciones hist├│ricas por created_at (la tabla no tiene columna 'day')
      ...
      // Restar consumos y dejar solo d├¡as con saldo > 0
  ...
  // Procesar timelogs para agrupar por d├¡a
  ...
  private calculateTotalOvertimeHours(logs: any[]): number {
    ...
    logs.forEach((log) => {
      ...
      // Regla igual a Marcaciones: overtime sobre trabajo neto (sin contar almuerzo, m├íximo 60m)
  ...
  // Extraer d├¡as con horas extras con informaci├│n detallada
  private extractOvertimeDays(logs: any[]): Array<{
    ...
    logs.forEach((log) => {
      ...
      // Solo agregar d├¡as con horas extras > 0
  ...
  public approveCompensatoryRequest(request: CompensatoryRequest): void {
    ...
    this.confirmationService.confirm({
      message: `┬┐Est├ís seguro de aprobar la solicitud de tiempo compensatorio de ${employeeName}?`,
  ...
  public rejectCompensatoryRequest(request: CompensatoryRequest): void {
    this.confirmationService.confirm({
      message: `┬┐Est├ís seguro de rechazar la solicitud de tiempo compensatorio de ${this.getEmployeeName(
        request
      )}?`,
  ...
  public loadMoreOvertimeHistory(): void {
    ...
    // Ampliar ventana hist├│rica (1 a├▒o m├ís) y recargar c├ílculo
      ...
      .subscribe({
        next: async () => {
          ...
          if (status === 'approved' && request) {
            // Enviar notificaci├│n al empleado sobre la aprobaci├│n
            await this.notifyEmployee(id, request, 'approved');
            // Enviar notificaci├│n a Lia para que registre
            await this.notifyLiaForRegistration(id, request);

            // Consumir horas extra (auditable) al aprobar. Best-effort: no bloquea aprobaci├│n.
            try {
              await this.consumeOvertimeForApprovedRequest(request, oldStatus);
              // Refrescar panel de overtime si est├í abierto
              if (this.showCompensatoryDetailsDialog()) {
                void this.loadEmployeeOvertimeHours(request.employee_id);
              }
            } catch (e) {
              console.warn(
                '[HRDisabilities] No se pudo consumir overtime autom├íticamente',
                e
              );
            }
          } else if (status === 'rejected' && request) {
            // Enviar notificaci├│n al empleado sobre el rechazo
          ...
          this.compensatoryTimeoffsApi.reload();
          // Recargar historial si el di├ílogo est├í abierto
          if (
  ...
  private async consumeOvertimeForApprovedRequest(
    ...
    if (manualIsoDays.length > 0) {
      // Traer timelogs y consumos solo para esas fechas (hist├│rico)
      const timelogs = await firstValueFrom(
        this.http.get<any[]>(
          `${process.env['ENV_SUPABASE_URL']}/rest/v1/timelogs`,
          {
      ...
      // Fallback: usar los d├¡as con saldo ya calculados (rango cargado)
      candidates = (this.employeeOvertimeDaysAll() ?? [])
        .map((d) => ({ day: d.day, remainingHours: d.overtimeHours }))
        .filter((x) => x.remainingHours > 0);
    }

    // Consumir desde los d├¡as m├ís antiguos primero (FIFO)
    ...
    for (const c of candidates) {
      ...
      rows.push({
        ...
        created_by: actor.id,
        comment: 'Consumido autom├íticamente al aprobar compensatorio',
      });
    ...
    await this.auditService.logChange({
      ...
      oldStatus,
      newStatus: 'approved',
      comment: `Overtime consumido autom├íticamente al aprobar: ${rows
  ...
  private async notifyLiaForRegistration(
    ...
    try {
      ...
      // Buscar posici├│n exacta de Lia: "Especialista de N├│mina y Gesti├│n Administrativa"
      const liaPositions = await firstValueFrom(
        this.http.get<any[]>(
          `${process.env['ENV_SUPABASE_URL']}/rest/v1/positions`,
          {
            params: {
              select: 'id',
              name: 'eq.Especialista de N├│mina y Gesti├│n Administrativa',
              company_id: `eq.${companyId}`,
            },
          }
        )
      ...
      if (!liaPositions || liaPositions.length === 0) {
        console.warn(
          'No se encontr├│ la posici├│n "Especialista de N├│mina y Gesti├│n Administrativa"'
        );
        return;
      }
      ...
      console.error('Error enviando notificaci├│n a Lia:', error);
    }
  }
  ...
  private async notifyEmployee(
    ...
    try {
      ...
      console.error('Error enviando notificaci├│n al empleado:', error);
    }
  }
  ...
  public attachDocumentToCompensatoryRequest(): void {
    ...
    input.onchange = async (event: any) => {
      ...
      if (file.type !== 'application/pdf') {
        this.messageService.add({
          severity: 'error',
          summary: 'Tipo de archivo inv├ílido',
      ...
      try {
        ...
        this.messageService.add({
          ...
          detail: 'El documento se adjunt├│ correctamente a la solicitud.',
        });
        ...
        this.messageService.add({
          ...
          detail: 'No se pudo adjuntar el archivo. Int├®ntalo nuevamente.',
        });
      }
    };
  ...
  public approveDisability(disability: Disability): void {
    this.confirmationService.confirm({
      message: `┬┐Est├ís seguro de aprobar la incapacidad de ${disability.employee?.first_name} ${disability.employee?.father_name}?`,
      header: 'Confirmar Aprobaci├│n',
      icon: 'pi pi-exclamation-triangle',
      acceptButtonStyleClass: 'p-button-success',
      accept: () => {
  ...
  public rejectDisability(disability: Disability): void {
    this.confirmationService.confirm({
      message: `┬┐Est├ís seguro de rechazar la incapacidad de ${disability.employee?.first_name} ${disability.employee?.father_name}?`,
      header: 'Confirmar Rechazo',
      icon: 'pi pi-exclamation-triangle',
      acceptButtonStyleClass: 'p-button-danger',
      accept: () => {
  ...
  public approveVacation(vacation: VacationRequest): void {
    ...
    this.confirmationService.confirm({
      message: `┬┐Est├ís seguro de aprobar las vacaciones de ${employeeName}?`,
      header: 'Confirmar Aprobaci├│n',
      icon: 'pi pi-exclamation-triangle',
      acceptButtonStyleClass: 'p-button-success',
      accept: () => {
  ...
  public rejectVacation(vacation: VacationRequest): void {
    this.confirmationService.confirm({
      message: `┬┐Est├ís seguro de rechazar las vacaciones de ${vacation.employee?.first_name} ${vacation.employee?.father_name}?`,
      header: 'Confirmar Rechazo',
      icon: 'pi pi-exclamation-triangle',
      acceptButtonStyleClass: 'p-button-danger',
      accept: () => {
  ...
  public viewVacationDetails(vacation: VacationRequest): void {
    ...
    this.messageService.add({
      severity: 'info',
      summary: 'Informaci├│n',
      detail: 'Vista de detalles pr├│ximamente disponible',
    });
  }
  ...
  public approveDocument(document: DocumentRequest): void {
    ...
    this.confirmationService.confirm({
      message: `┬┐Est├ís seguro de aprobar la solicitud de ${this.getDocumentTypeLabel(
  ...
  public rejectDocument(document: DocumentRequest): void {
    this.confirmationService.confirm({
      message: `┬┐Est├ís seguro de rechazar la solicitud de ${this.getDocumentTypeLabel(
        document.document_type
        ...
        message:
          status === 'approved'
            ? `Tu solicitud de ${this.getDocumentTypeLabel(
                document.document_type
              )} ha sido aprobada y estar├í disponible pr├│ximamente.`
            : `Tu solicitud de ${this.getDocumentTypeLabel(
                document.document_type
              )} ha sido rechazada.${
                rejectionComment ? ` Motivo: ${rejectionComment}` : ''
