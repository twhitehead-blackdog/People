...
export const PositionsStore = signalStore({ providedIn: 'root' },
  withCustomEntities<Position>({
    name: 'positions',
    query: 'id,name,department_id,available_for_job_fair,admin,schedule_admin,schedule_approver,default_view,frontend_permissions,department:departments(id, name)',
    order: 'name',
  })
  ...
  // Nota: default_view se remueve automáticamente para naz_positions
);
