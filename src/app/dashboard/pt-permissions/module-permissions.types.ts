...
export const SYSTEM_MODULES: ModuleDefinition[] = [
  ...
  },
  {
    ...
    subModules: [
      ...
      { id: 'tickets_view_all',    label: 'Tickets · Vista Global', description: 'Ver TODOS los tickets de todos los deptos + KPIs', icon: 'pi pi-globe',   route: 'tickets-all' },
      { id: 'tickets_my_branch',   label: 'Tickets · Mi Sucursal',  description: 'Ver tickets de su sucursal (gerentes)',           icon: 'pi pi-building', route: 'tickets-my-store' },
      { id: 'tickets_it',          label: 'Tickets · IT',           description: 'Tickets de soporte técnico',              icon: 'pi pi-desktop', route: 'tickets-it' },
      { id: 'tickets_operations',  label: 'Tickets · Operaciones',  description: 'Tickets de operaciones (insumos, mant.)', icon: 'pi pi-cog',     route: 'tickets-operations' },
      { id: 'tickets_accounting',  label: 'Tickets · Contabilidad', description: 'Tickets de contabilidad / pagos',         icon: 'pi pi-dollar',  route: 'tickets-accounting' },
      { id: 'tickets_hr',          label: 'Tickets · RRHH',         description: 'Tickets para Recursos Humanos',           icon: 'pi pi-users',   route: 'tickets-hr' },
      { id: 'suggestions_admin',   label: 'Sugerencias',            description: 'Buzón de ideas y mejoras propuestas',     icon: 'pi pi-lightbulb', route: 'suggestions' },
  ...
  },
  {
    ...
    subModules: [
      ...
      { id: 'salon_top', label: 'Top Peluquería', description: 'Ranking de estilistas por metas/comisiones (Odoo)', icon: 'pi pi-trophy', route: 'salon-schedule' },
