      ...
      <ng-template pTemplate="footer">
        ...
        <div class="flex items-center gap-3">
          <button
            ...
            [class]="selectedDocument()!.status === 'pending'
            ...
            (click)="updateDocumentStatusFromDialog('pending')"
          >
          ...
          <button
            class="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg text-sm font-semibold transition-all duration-200 active:scale-[0.98]"
            [class]="selectedDocument()!.status === 'completed'
            ...
            (click)="openCompleteDialog(selectedDocument()!)"
          >
          ...
          <button
            class="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg text-sm font-semibold transition-all duration-200 active:scale-[0.98]"
            [class]="selectedDocument()!.status === 'rejected'
            ...
            (click)="showDetailsDialog.set(false); openRejectionDialog(selectedDocument()!)"
          >
